...
public class Bot extends TelegramBot {
                        ...
                        switch (callback) {
                            ...
                            case "mailing":
                                ...
                                if (!Boolean.TRUE.equals(already.getBody())) {
                                    ...
                                    this.execute(new SendMessage(id, "Выберите время (час) рассылки расписания " +
    ...
    public void handleGroupInput(Update update) throws IOException {
        ...
        if(groupnameToClassic.codePoints().filter(Character::isAlphabetic).count()==0) groupnameToClassic = toElFormat.toLowerCase();
